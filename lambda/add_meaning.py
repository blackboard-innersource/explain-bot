...
@lru_cache(maxsize=60)
def add_definition(acronym, definition, meaning, notes, response_url, user_id):
...
def lambda_handler(event, context):
    ...
    status_code = add_definition(acronym,definition,meaning,notes,return_url,user_id)
